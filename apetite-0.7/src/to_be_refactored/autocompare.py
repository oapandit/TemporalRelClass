...
#
# TODO:
#   - séparer eval des mesures pour faire graphes directo dans tableur (au lieu de cette
#     bouillie)
#     test avec cut
...
#   - comparer en affaiblissnt l'annotation de départ
#   - ajout DICE coeff ?
...
# OK: et on peut voir que g2 pas les mêmes relations que annotation (g1=make_graph(data1bis))
"""
