...
##        return res
	...
	"""revise an edge label by intersecting with another relation"""
        ...
        if len(r)==0:
            ...
            # OP : Following two lines were out of else loop. changed it.
            ...
            for c2 in related:
                ...
                if node1!=c2n2:
                    ...
                    # evite de faire le test apres l'intersection
                        ...
                        if not(cons):
                            #OP : changing consistent to True. It should be false.
                            # # consistent=False
                            # print "Inconsitency found"
                            # print "---------\n arc1 -:", c
                            # print "arc2 -----", c2
                            # print "compo->", node1, c2n2, res
                            # print "old relations",target.relation()
                            consistent = True
                        if chg:
                            changed=True
                    else:
	...
	"""propagate constraints until a fixpoint is reached on the graph
        ...
        while (cons) and (changed):
            if counter>5:
                break
            # print 20*"###"
            # print "Saturation of graph, loop : ",str(counter)
    ...
    def propagate(self):
        ...
        for i in range(self._entity_nb):
            for j in range(self._entity_nb):
                ...
                if compo==0:
                    # return (False,True)
                    # OP : masking the inconsistency
                    print "Inconsistency found; but masked"
                    changed = True
                    pass
