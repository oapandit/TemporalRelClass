...
def final_score():
    ...
    fscore = 100 * round(fscore, 6)
    precision = 100 * round(precision, 6)
    recall = 100 * round(recall, 6)

    print 'Temporal Score\tF1\tP\tR'
    print '\t\t' + str(fscore) + '\t' + str(precision) + '\t' + str(recall) + '\t'
    print 'Overall Temporal Awareness Score (F1 score):', str(fscore)
    print ''
    return [precision,recall,fscore]

# take input from command line and give error messages
# call appropriate functions to evaluate 
def input_and_evaluate(arg1, arg2, debug, evaluation_method_):
    global evaluation_method
    evaluation_method = evaluation_method_
    invalid = 'false'
    # if len(sys.argv) < 3:
    #     invalid = 'true'
    # else:
...
if __name__ == '__main__':
    arg1 = ''
    arg2 = ''
    input_and_evaluate(arg1, arg2, debug, evaluation_method)
